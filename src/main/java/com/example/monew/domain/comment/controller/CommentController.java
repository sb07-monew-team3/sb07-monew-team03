...
public class CommentController implements CommentControllerDocs {
    ...
    public CommentCursorPageResponse<CommentResponse> list(
        ...
        return commentQueryService.getCommentsForFront(
                userId, articleId, orderBy, direction, cursor, after, limit
        );
    }
    ...
    public CursorPageResponse<CommentResponse> listByCursor(
        ...
        return commentQueryService.getCommentsByCursor(
                userId,
                new CommentCursorListRequest(articleId, orderBy, direction, cursor, after, limit)
        );
    }
}
